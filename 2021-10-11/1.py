...
class Ball:
    ...
    def __init__(self):
        ...
        self.surface = pygame.Surface((self.r*2, self.r*2), pygame.SRCALPHA, 32)
...
class Boris:
    ...
    def __init__(self):
        ...
        self.surface.blit(self.image, pygame.rect.Rect(0,0, self.r*2, self.r*2))
        self.starting_time = pygame.time.get_ticks()
...
def print_the_player_list(list_of_players):
    for num, player in enumerate(list_of_players):
        screen.blit(font.render(str(num+1) + '. ' + player[0] + ' ' + str(player[1]), True, (255, 255, 255)), (150, 60*num))
...
while not finished:
    ...
    screen.blit(font.render(str(ball_genocide_counter), True, (255, 255, 255)), (60, 60))
